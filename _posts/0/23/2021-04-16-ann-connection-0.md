...
---
Suatu arsitektur JST berjenis feed forward terdiri beberapa neuron masukan ($\LARGE \color{#ffcc00} \bullet$), beberapa neuron tersembunyi ($\LARGE \color{#66cc00} \bullet$) dalam sejumlah layer tersembunyi, dan beberapa neuron keluaran ($\LARGE \color{#ff6600} \bullet$).
