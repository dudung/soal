...
---
In kinematics we learn about object motion without considering the cause of the motion, i.e. the force [[1](#ref1)]. Parameters of motion, e.g. [position](position), [velocity](velocity), [acceleration](acceleration), and time [[2](#ref2)], and also others derived from those will be used in describing kinematics.
