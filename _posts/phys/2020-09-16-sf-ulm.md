...
2. Think about displacement and distance. Find displacement and distance for time $0 \ {\rm s} \le t \lt 3 \ {\rm s}$, $3 \ {\rm s} \le t \lt 6 \ {\rm s}$, $6 \ {\rm s} \le t \lt 13 \ {\rm s}$,  and $13 \ {\rm s} \le t \lt 15 \ {\rm s}$.
3. Find displacement and distance for time $0 \ {\rm s} \le t \lt 3 \ {\rm s}$, $0 \ {\rm s} \le t \lt 6 \ {\rm s}$, $0 \ {\rm s} \le t \lt 13 \ {\rm s}$, and $0 \ {\rm s} \le t \lt 15 \ {\rm s}$.
4. Find the velocity $v$ in each time interval $0 \ {\rm s} \le t \lt 3 \ {\rm s}$, $3 \ {\rm s} \le t \lt 6 \ {\rm s}$, $6 \ {\rm s} \le t \lt 13 \ {\rm s}$,  and $13 \ {\rm s} \le t \lt 15 \ {\rm s}$,  and make a table and a function for it.
5. Make your onw problem and visualize the information using table, sequence of pictures, graph, and function. Use at least four different points, e.g. $A$, $B$, $C$, $D$.


## Quiz
A partikel is moving and visiting points $P$, $Q$, $R$, $S$, $T$, and $U$ as illustrated in Fig. <a href="#fig:sfulm-1d-x-t-quiz-1">3</a>.

<oo>
svg 480 440 #fafafa fig:sfulm-1d-x-t-quiz-1|A step function velocity uniform linear motion with five time intervals.

style lc:#000 ls:6-2 lw:0.3 lo:0.8
grid 20 20 460 420 20 20

style lc:#000 ls:0 lw:1 lo:1
arrow 20 420 460 420
arrow 20 420 20 20

line 60 417 60 423
line 100 417 100 423
line 140 417 140 423
line 180 417 180 423
line 220 417 220 423
line 260 417 260 423
line 300 417 300 423
line 340 417 340 423
line 380 417 380 423
line 420 417 420 423
...
In each time interval the particle performs a [uniform linear motion](uniform-linear-motion) or its velocity is constant in each time interval.
