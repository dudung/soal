...
## Quiz
A partikel is moving and visiting points $P$, $Q$, $R$, $S$, $T$, and $U$ as illustrated in Fig. <a href="#fig:sfulm-1d-x-t-quiz-1">1</a>. In each time interval it performs a [uniform linear motion](uniform-linear-motion).
