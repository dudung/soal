...
4. Find the velocity $v$ in each time interval, e.g. $0 \ {\rm s} \le t \lt 3 \ {\rm s}$, $3 \ {\rm s} \le t \lt 6 \ {\rm s}$, $6 \ {\rm s} \le t \lt 13 \ {\rm s}$,  and $13 \ {\rm s} \le t \lt 15 \ {\rm s}$,  and make a table and a function for it.
